...
class cmdVelPublisher:
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher("/target_frame/right", Twist, queue_size=1)
        self.sub = rospy.Subscriber("test", Float64, self.setVelocity_cb)


        rospy.Timer(rospy.Duration(1), self.publish)
...
class converter:
    ...
    def __init__(self):
        ...
        self.startup_topic = rospy.get_param('~startup_topic', default="my_startup")
        ...
        self.startup_sub = rospy.Subscriber(self.startup_topic, Empty, self.startup_cb)
        self.last = time.time()
    ...
    def startup_cb(self, data):
        self.startup()
        rospy.logerr("startup_cb called!!")
