...
grasp.grasp_pose.pose.position = Vector3(1.5, -0.2, 1)
...
box_name = "object"
box_pose.pose.position = Vector3(1.5, -0.2, 1)
scene.add_box(box_name, box_pose, size=(2.02, 2.02, 0.2))

# 把持ポーズの候補を与える
is_grasp_succeeded = move_group.pick(box_name, [grasp])
rospy.logerr("######")
